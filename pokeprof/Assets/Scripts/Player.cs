...
public class Player : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            transform.Translate(
                new Vector3(movementJoystick.joystickVec.x * playerSpeed * Time.deltaTime, 0f, 0f)
            );
            playerMoving = true;
        ...
        {
            transform.Translate(
                new Vector3(0f, movementJoystick.joystickVec.y * playerSpeed * Time.deltaTime, 0f)
            );
            playerMoving = true;
